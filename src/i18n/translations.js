...
const translations = {
  ...
  'product.noImagesForColor': { ar: 'لا توجد صور لهذا اللون', en: 'No images available for this color' },

  // Admin — per-color product images (Stage 31)
  'adminImages.colorImages': { ar: 'صور اللون', en: 'Color Images' },
  'adminImages.uploadImages': { ar: 'رفع صور', en: 'Upload Images' },
  'adminImages.uploading': { ar: 'جاري الرفع...', en: 'Uploading...' },
  'adminImages.dropHint': { ar: 'اضغط لاختيار الصور او اسحبها هنا', en: 'Click to choose images or drag them here' },
  'adminImages.sizeHint': { ar: 'JPG, PNG, WEBP — حتى 5 ميجابايت لكل صورة', en: 'JPG, PNG, WEBP — up to 5MB each' },
  'adminImages.deleteImage': { ar: 'حذف الصورة', en: 'Delete Image' },
  'adminImages.setPrimary': { ar: 'تحديد كصورة رئيسية', en: 'Set as primary image' },
  'adminImages.primary': { ar: 'رئيسية', en: 'Primary' },
  'adminImages.moveUp': { ar: 'تحريك للاعلى', en: 'Move up' },
  'adminImages.moveDown': { ar: 'تحريك للاسفل', en: 'Move down' },
  'adminImages.noImagesYet': { ar: 'لا توجد صور مضافة لهذا اللون بعد', en: 'No images added for this color yet' },
  'adminImages.noImagesYetProduct': { ar: 'لا توجد صور مضافة لهذا المنتج بعد', en: 'No images added for this product yet' },
  'adminImages.generalImages': { ar: 'صور عامة (بدون لون محدد)', en: 'General Images (no color assigned)' },
  'adminImages.generalImagesHint': {
    ar: 'صور قديمة تظهر كاحتياطي للالوان التي ليس لها صور خاصة بها',
    en: 'Legacy images shown as a fallback for colors with no color-specific images of their own',
  },
  'adminImages.backToProducts': { ar: 'العودة الى المنتجات', en: 'Back to products' },
  'adminImages.pageTitle': { ar: 'صور المنتج', en: 'Product Images' },
  'adminImages.pageHintNoColors': {
    ar: 'رفع وادارة صور المنتج. يمكن تحديد الصورة الرئيسية وترتيب الصور.',
    en: 'Upload and manage this product\u2019s images. You can set the primary image and reorder images.',
  },
  'adminImages.pageHintWithColors': {
    ar: 'رفع وادارة صور كل لون على حدة. يمكن تحديد الصورة الرئيسية للمنتج وترتيب صور كل لون.',
    en: 'Upload and manage each color\u2019s images separately. You can set the product\u2019s primary image and reorder each color\u2019s images.',
  },
  'adminImages.loadError': { ar: 'حدث خطا اثناء تحميل بيانات المنتج', en: 'Failed to load product data' },
  'adminImages.uploadedOne': { ar: 'تم رفع الصورة بنجاح', en: 'Image uploaded successfully' },
  'adminImages.uploadedMany': { ar: 'تم رفع {count} صور بنجاح', en: '{count} images uploaded successfully' },
  'adminImages.deleted': { ar: 'تم حذف الصورة', en: 'Image deleted' },
  'adminImages.deleteFailed': { ar: 'تعذر حذف الصورة', en: 'Failed to delete the image' },
  'adminImages.primarySet': { ar: 'تم تحديد الصورة الرئيسية', en: 'Primary image set' },
  'adminImages.primaryFailed': { ar: 'تعذر تحديد الصورة الرئيسية', en: 'Failed to set the primary image' },
  'adminImages.reorderFailed': { ar: 'تعذر حفظ الترتيب الجديد', en: 'Failed to save the new order' },
  'adminImages.confirmDelete': { ar: 'هل تريد حذف هذه الصورة؟', en: 'Delete this image?' },
  'adminImages.uploadFailed': { ar: 'تعذر رفع الصورة', en: 'Failed to upload the image' },
  'adminImages.invalidType': { ar: 'نوع الملف غير مدعوم (JPG, PNG, WEBP فقط)', en: 'Unsupported file type (JPG, PNG, WEBP only)' },
  'adminImages.tooLarge': { ar: 'حجم الملف اكبر من 5 ميجابايت', en: 'File is larger than 5MB' },
  ...
  'checkout.city': { ar: 'المنطقة', en: 'Area' },
