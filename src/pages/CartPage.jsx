      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          {items.map((item) => (
            <div key={item.key} className="flex gap-4 rounded-2xl border border-gray-100 p-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-bold text-red-500 mt-2">{formatKWD(item.unitPrice, language)}</p>
        ...
        <div className="rounded-2xl border border-gray-100 p-5 h-fit">
          <div className="flex items-center justify-between text-sm text-gray-600">
            ...
            <span className="font-bold text-red-500">{formatKWD(subtotal, language)}</span>
          </div>
